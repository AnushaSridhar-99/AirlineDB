...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2019 at 07:32 AM
...
('dg11', 'Delhi', 'Gujarat', '2019-12-14', '09:10:00', 165, 3700),
('dh11', 'Delhi', 'Hyderabad', '2019-12-13', '16:30:00', 154, 4150),
...
--
ALTER TABLE `booking`
  MODIFY `BookingID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `passengers`
--
ALTER TABLE `passengers`
  MODIFY `PNRNumber` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
COMMIT;
